...
def test_command(command, index):
    ...
    try:
        ...
        # Call Ollama API with Llama 4 Maverick
...
def main():
    print("Starting Llama 4 Maverick Shell Command Testing")
    print(f"Model: Llama 4 Maverick (400B MoE, 17B active)")
